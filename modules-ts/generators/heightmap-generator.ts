declare var HeightmapGenerator: () => {
  generate: any;
  addHill: any;
  addRange: any;
  addTrough: any;
...
HeightmapGenerator = () => {
  ...
  function addStep(a1, a2, a3, a4, a5) {
    if (a1 === 'Hill') addHill(a2, a3, a4, a5);
    else if (a1 === 'Pit') addPit(a2, a3, a4, a5);
    else if (a1 === 'Range') addRange(a2, a3, a4, a5);
    else if (a1 === 'Trough') addTrough(a2, a3, a4, a5);
    else if (a1 === 'Strait') addStrait(a2, a3);
    else if (a1 === 'Add') modify(a3, a2, 1);
    else if (a1 === 'Multiply') modify(a3, 0, a2);
    else if (a1 === 'Smooth') smooth(a2);
  }

...
Cultures = () => {
    ...
    function getRandomCultures(c) {
      ...
      while (cultures.length < count) {
        ...
        do {
          ...
          !P(culture.odd) ||
          cultures.find((c) => c.name === culture.name)
        );
  ...
  function getCode(name) {
    ...
    for (
      let i = 1;
      i < letters.length - 1 && pack.cultures.some((c) => c.code === code);
      i++
    ) {
  ...
  const getDefault = function (count) {
    ...
    if (culturesSet.value === 'oriental') {
      return [
        ...
        { name: 'Carnatic', base: 26, odd: 0.5, sort: (i) => n(i) / td(i, 26) },
        {
          name: 'Vietic',
          base: 29,
          odd: 0.8,
        ...
        { name: 'Guantzu', base: 30, odd: 0.5, sort: (i) => n(i) / td(i, 17) },
        {
          name: 'Ulus',
          base: 31,
          odd: 1,
    ...
    if (culturesSet.value === 'highFantasy') {
      return [
        ...
        { name: 'Yotunn', base: 38, odd: 0.9, sort: (i) => td(i, -10) }, // Giant
        { name: 'Drake', base: 39, odd: 0.7, sort: (i) => -s[i] }, // Draconic
        { name: 'Rakhnid', base: 40, odd: 0.9, sort: (i) => t[i] - s[i] }, // Arachnid
        {
          name: "Aj'Snaga",
          base: 41,
          odd: 0.9,
        ...
        { name: 'Izenlute', base: 0, odd: 0.1, sort: (i) => n(i) / td(i, 5) },
        {
          name: 'Lurian',
          base: 2,
          odd: 0.1,
        ...
        { name: 'Getalian', base: 3, odd: 0.1, sort: (i) => n(i) / td(i, 15) },
        { name: 'Astelan', base: 4, odd: 0.05, sort: (i) => n(i) / td(i, 16) },
        ...
        { name: 'Turan', base: 16, odd: 0.05, sort: (i) => n(i) / td(i, 13) },
        {
          name: "Al'Uma",
          base: 18,
          odd: 0.05,
    ...
    if (culturesSet.value === 'darkFantasy') {
      return [
        ...
        { name: 'Hetallian', base: 3, odd: 0.3, sort: (i) => n(i) / td(i, 15) },
        { name: 'Astellian', base: 4, odd: 0.3, sort: (i) => n(i) / td(i, 16) },
        // rare real-world exotic
        {
          name: 'Kiswaili',
          base: 28,
        ...
        { name: 'Hantzu', base: 11, odd: 0.05, sort: (i) => n(i) / td(i, 13) },
        {
          name: 'Yamoto',
          base: 12,
          odd: 0.05,
        ...
        { name: 'Guantzu', base: 30, odd: 0.05, sort: (i) => n(i) / td(i, 17) },
        {
          name: 'Ulus',
          base: 31,
          odd: 0.05,
        ...
        { name: 'Turan', base: 16, odd: 0.05, sort: (i) => n(i) / td(i, 12) },
        {
          name: 'Berberan',
          base: 17,
          odd: 0.05,
        ...
        { name: 'Durinn', base: 35, odd: 0.8, sort: (i) => n(i) + h[i] }, // Dwarven
        { name: 'Kobblin', base: 36, odd: 0.8, sort: (i) => t[i] - s[i] }, // Goblin
        {
          name: 'Uruk',
          base: 37,
          odd: 0.8,
        ...
        { name: 'Yotunn', base: 38, odd: 0.8, sort: (i) => td(i, -10) }, // Giant
        { name: 'Drake', base: 39, odd: 0.9, sort: (i) => -s[i] }, // Draconic
        { name: 'Rakhnid', base: 40, odd: 0.9, sort: (i) => t[i] - s[i] }, // Arachnid
        {
          name: "Aj'Snaga",
          base: 41,
    ...
    return [
      ...
      { name: 'Tallian', base: 3, odd: 0.6, sort: (i) => n(i) / td(i, 15) },
      { name: 'Astellian', base: 4, odd: 0.6, sort: (i) => n(i) / td(i, 16) },
      {
        name: 'Slovan',
        base: 5,
        odd: 0.7,
      ...
      { name: 'Norse', base: 6, odd: 0.7, sort: (i) => n(i) / td(i, 5) },
      {
        name: 'Elladan',
        base: 7,
        odd: 0.7,
      ...
      { name: 'Romian', base: 8, odd: 0.7, sort: (i) => n(i) / td(i, 15) },
      {
        name: 'Soumi',
        base: 9,
        odd: 0.3,
      ...
      { name: 'Hantzu', base: 11, odd: 0.1, sort: (i) => n(i) / td(i, 13) },
      {
        name: 'Yamoto',
        base: 12,
        odd: 0.1,
      ...
      { name: 'Turchian', base: 16, odd: 0.2, sort: (i) => n(i) / td(i, 13) },
      {
        name: 'Berberan',
        base: 17,
        odd: 0.1,
      ...
      { name: 'Carnatic', base: 26, odd: 0.05, sort: (i) => n(i) / td(i, 26) },
      { name: 'Inqan', base: 27, odd: 0.05, sort: (i) => h[i] / td(i, 13) },
      {
        name: 'Kiswaili',
        base: 28,
        odd: 0.1,
      ...
      { name: 'Guantzu', base: 30, odd: 0.1, sort: (i) => n(i) / td(i, 17) },
      {
        name: 'Ulus',
        base: 31,
        odd: 0.1,

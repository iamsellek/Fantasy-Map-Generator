...
function getPackPolygon(i: number | undefined): TwoNumberArray[] {
  if (!i) {
    return [];
  }
...
// filter land cells
function isLand(index: number): boolean {
...
function convertTemperature(c: number): string {
...
function rn(value: number, decimalPlaces: number = 0): number {
...
function round(s: string | null, d = 1): string {
...
function biased(min: number, max: number, ex: number): number {
...
function getAdjective(str: string): string {
...
function ra<T>(array: T[]): T | undefined {
  if (!array.length) {
    return undefined;
  }
...
function raU(array: Uint16Array | Uint32Array): number | undefined {
  if (!array.length) {
    return undefined;
  }
...
function rw(obj: Record<string, number>): string {
  const array = [];
...
// get next unused id
function getNextId(core: string, i: number = 1): string {
...
function link(URL: string, description: string): string {
...
function generateDate(from: number = 100, to: number = 1000): string {
